 ...
 */
class getPersonnalisationCreationRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\PersonnalisationCreationRepository' shared autowired service.
     *
     * @return \App\Repository\PersonnalisationCreationRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PersonnalisationCreationRepository.php';

        return $container->privates['App\\Repository\\PersonnalisationCreationRepository'] = new \App\Repository\PersonnalisationCreationRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
