 ...
 */
class getFormArtRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\FormArtRepository' shared autowired service.
     *
     * @return \App\Repository\FormArtRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'FormArtRepository.php';

        return $container->privates['App\\Repository\\FormArtRepository'] = new \App\Repository\FormArtRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
