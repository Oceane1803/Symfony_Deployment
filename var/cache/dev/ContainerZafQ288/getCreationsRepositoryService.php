 ...
 */
class getCreationsRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CreationsRepository' shared autowired service.
     *
     * @return \App\Repository\CreationsRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CreationsRepository.php';

        return $container->privates['App\\Repository\\CreationsRepository'] = new \App\Repository\CreationsRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
